                ...
                @foreach( $countries as $idx=>$country )
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="text-danger delete-btns" data-idx="{{ $country->name }}" ><i class="fas fa-trash" ></i></a>
                        </td>
                        <form id="formdelete-{{$country->name}}" action="/countries/{{$country->id}}" method="post" >
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
                        </form>
                    </tr>
    ...
    <script type="text/javascript" >
        ...
        $(document).ready(function(){
            ...
            $(document).on("click",'.editform',function(e){
                ...
                $getform = $('#formaction');
                $getform.attr('action',`countries/${$(this).data('id')}`);
