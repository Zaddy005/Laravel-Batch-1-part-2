                                ...
                                <div class="card shadow py-2 border-left-primarys">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <h5 class="text-xs fw-bold text-primary text-uppercase mb-1">Slaes (Monthly)</h5>
                                        ...
                                        <div id="purchases" class="carousel slide" data-bs-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                                ...
                                                <div class="carousel-item active">
                                                    ...
                                                    <div class="mb-3">
                                                        <p class="fw-bold text-small">Preorder <span class="text-muted">($2172M last month)</span></p>
                                                    </div>
                                                    <button class="btn btn-outline-secondary btn-sm d-flex align-items-center">
                                                        <i class="fas fa-calendar-alt me-1"></i>
                                                        <span>June</span>
                                                ...
                                                <div class="carousel-item">
                                                    ...
                                                    <div class="mb-3">
                                                        <p class="fw-bold text-small">Netorder <span class="text-muted">($272M last month)</span></p>
                                                    </div>
                                                    <button class="btn btn-outline-secondary btn-sm d-flex align-items-center">
                                                        <i class="fas fa-calendar-alt me-1"></i>
                                                        <span>June</span>
                            ...
                            <div class="col-lg-3 col-md-6 mb-2">
                                <div class="card shadow py-2 border-left-warnings">
                                    <div class="card-body">
                                        <div class="row justify-content-center align-items-center">
                                            <div class="col d-flex justify-content-between">
                                                <h5 class="text-xs fw-bold text-primary text-uppercase mb-1">Investers</h5>
                            ...
                            <div class="col-lg-8 mb-3">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center py-2">
                                        ...
                                        <div class="dropdown">
                                            <a href="javascirpt:void(0);" class="dropdown-toggle" data-bs-toggle="dropdown">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center border-bottom py-2">
                                            ...
                                            <div class="ms-3">
                                                ...
                                                <small class="text-muted mb-0"><i class="fa fa-map-marker-alt me-1"></i>Mandalay City, Myanmar.</small>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center border-bottom py-2">
                                            ...
                                            <div class="ms-3">
                                                ...
                                                <small class="text-muted mb-0"><i class="fa fa-map-marker-alt me-1"></i>Yangon City, Myanmar.</small>
                                            </div>
                                            <div class="badge bg-success p-1 ms-auto">
                                        ...
                                        <div class="d-flex align-items-center py-2">
                                            ...
                                            <div class="ms-3">
                                                ...
                                                <small class="text-muted mb-0"><i class="fa fa-map-marker-alt me-1"></i>Bago City, Myanmar.</small>
                                            </div>
                                            <div class="badge bg-success p-1 ms-auto">
                                                <i class="fas fa-check"></i>
                                            </div>
                            ...
                            <div class="col-lg-8">
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="javascipt:void(0);">Browse Illustrations on more</a>
                                    </div>
                                </div>
                            </div>
