...
class PostsController extends Controller
{
    ...
    public function create()
    {
        ...
        $tags = Tag::whereIn("status_id",[3])->get();
        return view('posts.create',compact('statuses',"types","tags","attshows"));
    }
    ...
    public function store(Request $request)
    {
        ...
        if(file_exists($request['image'])){
            ...
            $imagenewname = uniqid($user_id).$post['id'].$filename;
            $file->move(public_path('assets/img/post/'),$imagenewname);

            $post->image = 'assets/img/post/'.$imagenewname;
        }
    ...
    public function edit(string $id)
    {
        ...
        $types = Type::whereIn("id",[1,2])->get();
        $tags = Tag::whereIn("status_id",[3])->get();
        return view('posts.edit')->with('post',$post)->with("attshows",$attshows)->with('statuses',$statuses)->with("types",$types)->with('tags',$tags);
    }
